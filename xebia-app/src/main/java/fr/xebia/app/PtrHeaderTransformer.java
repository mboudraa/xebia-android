...
public class PtrHeaderTransformer extends HeaderTransformer {
    ...
    private void setupViewsFromStyles(Activity activity, View headerView) {
        final TypedArray styleAttrs = obtainStyledAttrsFromThemeAttr(activity,
                                                                     R.attr.ptrHeaderStyle,
                                                                     R.styleable.PullToRefreshHeader);
        ...
        if (bg != null && mContentLayout != null) {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
                mContentLayout.setBackgroundDrawable(bg);
            } else {
